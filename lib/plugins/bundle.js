      ...
      return function(files) {
        return new Promise(async function(resolve, reject) {
          ...
          bnd = function(file) {
            ...
            bundle = browserify(streamify(file.contents), {
              basedir: path.dirname(file.path) // set cwd to file name
            });
          ...
          return (await punk.d.mapAsync(files, async function(file) {
            return (await bnd(file));
          }));
        });
      };
    }
