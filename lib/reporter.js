...
jst = function(text) {
  ...
  n2 = (function() {
    ...
    for (i = 0, len1 = n.length; i < len1; i++) {
      str = n[i];
      results.push(str.replace(regexp, '$1\n'));
    }
    return results;
  })();
  return n2.join('\n');
...
reporter = {
  ...
  changed: function(name) {
    return reporter.message('Updated file ' + chalk.blue(name) + '!');
  },
  ...
  noFiles: function(glob) {
    return reporter.warn('Not found any files at entry ' + chalk.blue(glob) + '!');
  },
