...
var config, cwd, path, process, punk, reporter;
...
Object.assign(punk, require('./dev.js')(punk, reporter), require('./run-task.js')(punk, reporter), require('./run.js')(punk, reporter), require('./use.js')(punk, reporter), require('./file.js')(punk, reporter));
