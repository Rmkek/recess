...
module.exports = function(config, cwd) {
  ...
  // ADD BASIC PLUGINS #
  //####################
  recess.use([require('./plugins/bundle.js'), require('./plugins/mute.js'), require('./plugins/converter.js'), require('./plugins/minifier.js'), require('./plugins/concat.js'), require('./plugins/wrap-file.js'), require('./plugins/add.js'), require('./plugins/write.js'), require('./plugins/if.js'), require('./plugins/stat.js'), require('./plugins/path.js'), require('./plugins/remove.js')]);
  return recess;
};
